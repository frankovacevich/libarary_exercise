...
db.load_books_from_file(BOOKS_BACKUP)
db.load_users_from_file(USERS_BACKUP)

db.insert_individual_book("Harry Potter and the Philosopher's stone", "JK Rowling", "UK", "1997", "978-0747532743")
db.insert_individual_book("Harry Potter and the Philosopher's stone", "JK Rowling", "UK", "1997", "978-0747532743")
db.insert_individual_book("Harry Potter and the Philosopher's stone", "JK Rowling", "UK", "1997", "978-0747532743")

db.save_books_to_file(BOOKS_BACKUP)
...
db.save_users_to_file(USERS_BACKUP)
